...
export default function ListMenuProfile() {
  ...
  const [openCart, setOpenCart] = useState<HTMLButtonElement | null>(null);
  ...
  const isOpenCart = Boolean(openCart);
  ...
  return (
    <div className=" flex justify-end items-center">
      ...
      <Popover
        ...
        sx={{ zIndex: 9999 }}
      >
        <div className="w-96 flex flex-col items-stretch justify-between">
          <div className="flex items-center justify-between px-3 pt-2">
            <h3>My Cart</h3>
            <button
              className="px-4 py-1 text-white bg-[#235D55] rounded-full"
          ...
          <div className="flex items-center justify-between px-3 pt-2">
            <div className="flex items-center justify-start">
              <img src="/assets/items/cart-1.png" />
            ...
            <div>
              <p className="font-medium text-red-600">$51.64</p>
            </div>
          </div>
          <div className="flex items-center justify-between px-3 pt-2">
            <div className="flex items-center justify-start">
          ...
          <div className="flex items-center justify-end mt-2">
            <div className="flex items-start justify-end pr-2 pb-3">
              <p className="font-semibold text-lg mr-2">Subtotal:</p>
              <p className="text-red-600 font-semibold text-xl">$154.92</p>
            </div>
          </div>
        </div>
      </Popover>
