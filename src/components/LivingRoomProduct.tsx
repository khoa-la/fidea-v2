...
import { livingRoomProductItems } from "../constants";
import { Box, Grid, Pagination, Stack } from "@mui/material";
import LivingRoomProductItem from "./LivingRoomProductItem";

export default function LivingRoomProduct() {
  ...
  return (
    <>
      <div className="flex items-center justify-between w-full">
        <div>
          <h2 className="text-left py-4 text-3xl">Living Rooms</h2>
          <span>Total furniture set: 312</span>
        </div>
